<?php
/**
 * api/like.php - Beğeni AJAX Endpoint
 * POST: Beğeni ekleme/kaldırma (toggle)
 */
...
$stmt = $pdo->prepare("SELECT id FROM likes WHERE user_id = ? AND movie_id = ?");
...
// Güncel beğeni sayısı
$like_count = get_like_count($pdo, $movie_id);

echo json_encode([
    'success'    => true,
    'liked'      => $liked,
    'like_count' => $like_count,
    'message'    => $liked ? 'Film beğenildi!' : 'Beğeni kaldırıldı.'
]);
